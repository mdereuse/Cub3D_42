...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/23 09:43:38 by mariedere         #+#    #+#             */
/*   Updated: 2020/05/08 07:46:47 by mariedere        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int argc, char **argv)
{
	...
	if (save)
		screenshot(game);
	set_window(&game);
	mlx_put_image_to_window(game.mlx_ptr, game.win_ptr, game.screen.id, 0, 0);
